...
import { ToggleComponent } from "../../common/helpers/ts/components";
import { Icon } from "@rightcom/right-lib";
import { useLayout } from "../../common/app-shell/core";
import RightCom from "../../common/app-shell/assets/images/RightCom.svg";
    ...
    <div className="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      ...
      {(appSidebarDefaultMinimizeDesktopEnabled ||
        ...
        >
          ...
          <Icon name="MdOutlineKeyboardDoubleArrowLeft" />
        </div>
      )}
    </div>
  );
